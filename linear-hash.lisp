...
(defconstant +lhash-count-offset+ 1)
(defconstant +lhash-next-overflow-pointer-offset+ 9)
(defconstant +lhash-next-split-offset+ 17)
(defconstant +lhash-level-offset+ 25)
(defconstant +lhash-key-bytes-offset+ 33)
(defconstant +lhash-value-bytes-offset+ 41)
(defconstant +lhash-bucket-size-offset+ 49)
(defconstant +lhash-bucket-bytes-offset+ 57)
(defconstant +lhash-null-key-offset+ 65)
